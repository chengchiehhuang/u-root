...
func getSMBIOSBase(start, end int64) (int64, error) {
	...
	return 0, fmt.Errorf("could not find _SM_ or _SM3_ via /dev/mem from %#08x to %#08x", start, end)
}
...
func GetSMBIOSBaseLegacy() (int64, error) {
